...
class WordCounter(Bolt):
	...
	self.conn = psycopg2.connect(database="final_project_filters", user="w205", password="pass", host="localhost", port="5432")
	...
	try:
		cur.execute ("INSERT INTO tweets_filters(created_at, tweet_id, tweet_text,source,quote_count, reply_count, retweet_count, favorite_count, lang, coordinates,place_coordinates, place_country,place_country_code,place_full_name,place_id, place_name,place_type,entities_hashtags,entities_urls,entities_expanded_url,entities_user_mentions, entities_symbols, user_id,user_name,user_screen_name,user_location,user_url, user_description,user_time_zone,user_lang,geo,timestamp)VALUES (%s,%s, %s, %s,%s,%s, %s,%s,%s, %s,%s, %s,%s, %s, %s, %s, %s,%s, %s, %s,%s,%s, %s,%s,%s, %s,%s, %s,%s, %s, %s, %s)",(             safe_str(tup.values[0]),
